 ...
 * 4. KRAKENTOOLS: Filter for target family reads
...
workflow PREPROCESSING {
    ...
    //=========================================================================
    // STEP 4: Filter reads for target family and unclassified reads
    //=========================================================================
    ...
    //=========================================================================
    FASTQC_PROCESSED(KRAKENTOOLS.out.filtered_reads, "processed")
    ...
    filtered_reads = KRAKENTOOLS.out.filtered_reads
    ...
    krakentools_summary = KRAKENTOOLS.out.summary
